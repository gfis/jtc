/* Representation of a chess field
...
public class ChessField {
    ...
    /** Sets the ChessField's color corresponding to its coordinates
     */
    ...
    /**
     * ChessPiece on the field, or EMPTY
     */
    ...
    /**
     * Get a ChessField's position corresponding to its coordinates
     *
    ...
    /**
     * Set a ChessField's coordinates corresponding to the internation notaation of
 the position.
     *
    ...
    public void setCoordinates(String position) {
     ...
     /** *  Gets the Unicode symbol for <em>this</em> ChessField
     *
     ...
     */
    public ChessField(String position, ChessPiece piece) {
        this();
    ...
    public static void main(String[] args) {
        ChessField field = new ChessField(0, 3); // ("d1", ChessPiece.QUEEN);
        field.setPiece(new ChessPiece(ChessPiece.WHITE, ChessPiece.QUEEN));
